...
var page = {
    init: function(){
        ...
        $previewColResizable = $('.wrap-preview-col').resizable({
            ...
            resize: function(event, ui) {
                ...
                var width = $('#form-editor').outerWidth() - $('.wrap-preview-col').outerWidth();
        ...
        tinymce.init({
            ...
            elements : "richEditor",
            plugins: "hr image pagebreak paste emoticons insertdatetime fullscreen visualblocks searchreplace preview charmap textcolor image print layer table save media contextmenu visualchars nonbreaking template link code",
    ...
    actionBuilderForm: function(){
        ...
        $('#fb-radio-horizontal').on('click', function(){
			...
			$('.fb-number-columns-radio option[value="'+opt.countColumns+'"]').attr('selected', true);
			$(".fb-number-columns-radio").trigger('liszt:updated');
			page.checkRadioBoxColumn(opt.countColumns, $tpl.find('.tpl-multiple-choise'));
        });
        ...
        $('#fb-checked-horizontal').on('click', function(){
			...
			$('.fb-number-columns-checkboxes option[value="'+opt.countColumns+'"]').attr('selected', true);
	...
	checkRadioBoxColumn: function(value, $box){
            ...
            $box
				.removeClass('fb-2-columns-chekboxes-radio fb-3-columns-chekboxes-radio fb-4-columns-chekboxes-radio fb-5-columns-chekboxes-radio')
    ...
    addFieldFormTitDesc: function(){
        if( !$('.info-form').find('.t-field').length ){
            ...
            $('.form-tit').hide().before('<div class="t-field"><label>Form Title</label><input type="text" class="txt-field fb-input-form-tit" value="'+tit+'"/></div>');
            $('.form-desc').hide().before('<div class="t-field"><label>Form Description</label><textarea class="txt-field fb-textarea-form-desc">'+desc+'</textarea></div>');
        }
    },
    ...
    actionsBtnBlock: function(){
            ...
            if ( !$block.hasClass('selected') ){
                ...
                if( $('.fb-right-panel-slide.active').length ){
                    $('.fb-right-panel-slide.active').removeClass('active').animate({left: '589px'}, 300,function(){
                        $(this).hide();
                        $('#fb-slide-panel-' + typeSlide).addClass('active').show().animate({left: 0},300);
                    });
                } else{
                    $('#fb-slide-panel-' + typeSlide).addClass('active').show().animate({left: 0},300);
                } 
        ...
        $('.eb-wrap-form-page').on('click','.tpl-block-delete', function(e){
            e.preventDefault();
            e.stopPropagation();
            if( $(this).parents('.tpl-block').hasClass('selected') ){
    ...
    dragAndDropElements: function(){
        ...
        $('.wrap-tpl-block').sortable({
            ...
            tolerance: 'intersect',
            cancel:'.fb-dragenddrop-box-text, .fb-dragenddrop-box-text, .tpl-block-edit, .tpl-block-clone, .tpl-block-delete, .txt-field',
    ...
    addElements: function($el, isDrop){
            ...
            if (type == 1){
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Paragraph_Question", "defaultIdentifier":"Paragraph_Question", "visible":"0", "labelText":"Paragraph", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='2'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Multiple_Choice_Question", "defaultIdentifier":"Multiple_Choice_Question", "visible":"0", "direction":"0", "countColumns":"3",  "labelText":"Multiple Choice", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='3'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Name_Question", "defaultIdentifier":"Name_Question", "visible":"0", "nameFirst":"First", "nameLast":"Last", "labelText":"Name", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='4'>"+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Time_Question", "defaultIdentifier":"Time_Question", "visible":"0", "labelText":"Time", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='5'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Address_Question", "defaultIdentifier":"Address_Question", "visible":"0", "labelText":"Address", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None", "dropdownBackground":"None", "dropdownBorderColor":"None", "dropdownFont":"None", "dropdownSize":"None", "dropdownColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='6'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Price_Question", "defaultIdentifier":"Price_Question", "visible":"0", "labelText":"Price", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='7'>"+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Section_Breack_Question", "defaultIdentifier":"Section_Breack_Question", "visible":"0", "labelText":"Section Breack", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='8'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Number_Question", "defaultIdentifier":"Number_Question", "visible":"0", "labelText":"Number", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='9'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Checkboxes_Question", "defaultIdentifier":"Checkboxes_Question", "visible":"0", "direction":"0", "countColumns":"3", "labelText":"Checkboxes", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='10'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Drop_Down_Question", "defaultIdentifier":"Drop_Down_Question", "visible":"0", "labelText":"Drop Down", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None", "dropdownBackground":"None", "dropdownBorderColor":"None", "dropdownFont":"None", "dropdownSize":"None", "dropdownColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='11'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Date_Question", "defaultIdentifier":"Date_Question", "visible":"0", "labelText":"Date", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='12'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Phone_Question", "defaultIdentifier":"Phone_Question", "visible":"0", "labelText":"Phone", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='13'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Web_Site_Question", "defaultIdentifier":"Web_Site_Question", "visible":"0", "labelText":"Web Site", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='14'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Email_Question", "defaultIdentifier":"Email_Question", "visible":"0", "labelText":"Email", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='15'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Page_Break_Question", "defaultIdentifier":"Page_Break_Question", "visible":"0", "labelText":"Page Break", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-page-break fb-add-new-el' data-type-el='16'>"+
                                '<div class="tpl-block-content clearfix">'+
                ...
                dataAll = '{"labelWidth":"None", "identifierCustom":"0", "identifier":"Calculated_Question", "defaultIdentifier":"Calculated_Question", "visible":"0", "labelText":"Calculated", "fieldLength":"None", "labelFont":"None", "labelSize":"None", "labelColor":"None", "labelPos":"None", "fieldBackground":"None", "fieldBorderStyle":"None", "fieldBorderWidth":"None", "fieldBorderColor":"None", "fieldBorderRadius":"None", "fieldFont":"None", "fieldSize":"None", "fieldColor":"None"}';
                
                htmlEl = "<div data-json='"+dataAll+"' class='tpl-block fb-add-new-el' data-type-el='17'>"+
                                '<div class="tpl-block-content clearfix">'+
    ...
    showHideInfBlock: function(){
        ...
        $('.wrap-tpl-block').each(function(){
            if ( $(this).find('.tpl-block').length > 0 ){
                $(this).find('.fb-dragenddrop-box-text').hide();
                if ( $(this).parents('.fb-wrap-three-columns, .fb-wrap-two-columns').length ){
                    $(this).removeClass('fb-noactive-container');
                }
                
            } else {
                $(this).find('.fb-dragenddrop-box-text').show();
                if ( $(this).parents('.fb-wrap-three-columns, .fb-wrap-two-columns').length ){
    ...
    elementsClone: function($btn){
      ...
      if ( type == '11' || type == '6'){
          ...
          $('.fb-clone-new').find('.chzn-container').remove();
          $select.replaceWith('<select>'+htmlOption+'</select>');
          $('.fb-clone-new').find('select').chosen();
      }
    ...
    editElementTpl: function(type){
        ...
        if (type == 0){
            ...
            if (type == 1 || type == 2 || type == 4 || type == 5 || type == 6 || type == 7 || type == 9  || type == 11 || type == 12 || type == 13 || type == 14 || type == 15 ){
                ...
                if (opt.fieldBorderRadius == 'None'){
                    $slide.find(".fb-field-border-radius").val(optGlobal.fieldBorderRadius);
                } else {
            ...
            if (type == 1 || type == 2 || type == 4 || type == 5 || type == 6 || type == 9 || type == 11 || type == 13 || type == 14 || type == 15 || type == 17){
				$slide.find('.fb-field-length option[value="'+opt.fieldLength+'"]').attr('selected', true);
            ...
            if (type == 3){
                ...
                if( opt.direction == '0'){
					...
					$('.fb-box-number-columns-radio').show();
					$slide.find('.fb-number-columns-radio option[value="'+opt.countColumns+'"]').attr('selected', true);
            ...
            if (type == 10){
                ...
                if( opt.direction == '0'){
                    ...
                    pages.checkboxRadioButtons.isChecked($('#fb-checked-horizontal'),true);
					$('.fb-box-number-columns-checkboxes').show();
					$slide.find('.fb-number-columns-checkboxes option[value="'+opt.countColumns+'"]').attr('selected', true);
    ...
    multipleAction: function(){
        $('.fb-multiple-field').on('click', '.fb-btn-add', function(){
            ...
            var content = '<div class="t-field">'+
                                ...
                                '<input type="text" class="txt-field" value="'+value+'"/>'+
                            '</div>';
            var $btn = $(this);
    ...
    addMultipleChoice: function(type){
        ...
        if( type == 'radio' ){
            var $box = $tpl.find('.tpl-multiple-choise');
            $box.append('<div class="t-field"><div class="t-radio"><label><i class="icn-radio"></i><input name="radiogroup" type="radio"><span class="fb-choice">Last option</span></label></div></div>');
        } else if(  type == 'checkbox' ){
            var $box = $tpl.find('.tpl-checkboxes');
            $box.append('<div class="t-field"><div class="t-checkbox"><label><i class="icn-checkbox"></i><input type="checkbox"><span class="fb-choice">Last option</span></label></div></div>');
        } else{
            var $select = $tpl.find('.t-field select');
            $select.find('option').eq(0).attr('selected', true);
    ...
    updateMultipleChoice:function(type){
        ...
        if (type == 'radio'){
            ...
            $tpl.find('.fb-choice').each(function(){
                text = $(this).text();
                content = '<div class="t-field">'+
                                '<a href="#" class="fb-btn-add t-btn-gray"></a> '+
                                '<a href="#" class="fb-btn-remove t-btn-gray"></a> '+
                                '<input type="text" class="txt-field" value="'+text+'"/>'+
                            '</div>';
                $box.append(content);
            });
    ...
    updateGlobalStyle: function(){
        ...
        if ( opt.isTransparentFormBackground === "1" ){
            ...
            pages.checkboxRadioButtons.isChecked($checkboxIsTransparentFormBackground, true);
        } else{
            bgColorForm = opt.formBackground;
            $checkboxIsTransparentFormBackground.attr('checked', false);
            pages.checkboxRadioButtons.isChecked($checkboxIsTransparentFormBackground, false);
        }
		...
		$('#fb-field-length-global option[value="'+opt.fieldLength+'"]').attr('selected', true);
        $("#fb-field-length-global").trigger('liszt:updated');
		
        $('#fb-label-font-global option[value="'+opt.labelFont+'"]').attr('selected', true);
        $("#fb-label-font-global").trigger('liszt:updated');
        $('#fb-label-size-global option[value="'+opt.labelSize+'"]').attr('selected', true);
        ...
        $('#fb-label-pos-global option[value="'+opt.labelPos+'"]').attr('selected', true);
        ...
        $('#fb-field-border-type-global option[value="'+opt.fieldBorderStyle+'"]').attr('selected', true);
        ...
        $('#fb-field-font-global option[value="'+opt.fieldFont+'"]').attr('selected', true);
        $("#fb-field-font-global").trigger('liszt:updated');
        $('#fb-field-size-global option[value="'+opt.fieldSize+'"]').attr('selected', true);
        ...
        $('#fb-dropdown-font-global option[value="'+opt.dropdownFont+'"]').attr('selected', true);
        $("#fb-dropdown-font-global").trigger('liszt:updated');
        $('#fb-dropdown-size-global option[value="'+opt.fieldSize+'"]').attr('selected', true);
        ...
        $('#fb-button-text, #fb-button-text-2').val($('.form-submit-button').text());
    ...
    labelPosition: function($tpl){
        ...
        if (opt.labelPos == 1){
            ...
            if ( type == '1' || type == '2' || type == '5' || type == '9' || type == '12' || type == '13' || type == '14' || type == '15' ){
			...
			if ( type == '6' || type == '11'){
				...
				$select.replaceWith('<select class="fb-select-address-country">' + $select.html() + '</select>');
				$select = $tpl.find('select.fb-select-address-country');
				$select.attr('data-placeholder', labelTextDropdown);	
				
				$select.prepend($('<option selected="selected" class="fb-placeholder-option"></option>'));
				$select.chosen();
	...
	fieldSize: function($tpl){
		...
		if (type == 1 || type == 2 || type == 4 || type == 5 || type == 6 || type == 7 || type == 9 || type == 11 || type == 13 || type == 14 || type == 15 || type == 17 ){
			...
			if ( type == 6 || type == 4){
				if ( opt.fieldLength == 'small' ){
					$tpl.find('.tpl-address, .tpl-name').children('.t-field, .f-line-field').removeClass('size-medium').addClass('size-small');
				} else if ( opt.fieldLength == 'medium' ){
					$tpl.find('.tpl-address, .tpl-name').children('.t-field, .f-line-field').removeClass('size-small').addClass('size-medium');
				} else if ( opt.fieldLength == 'large' ){
					$tpl.find('.tpl-address, .tpl-name').children('.t-field, .f-line-field').removeClass('size-small size-medium');
				}
			} else {
				...
				if ( opt.fieldLength == 'small' ){
					$tpl.find('.resizable-field').removeClass('size-medium').addClass('size-small');
				} else if ( opt.fieldLength == 'medium' ){
					$tpl.find('.resizable-field').removeClass('size-small').addClass('size-medium');
				} else if ( opt.fieldLength == 'large' ){
    ...
    actionStyleField: function(){
        ...
        $('.fb-label-size').change(function(){
            ...
            $tpl.find('.tpl-block-content').children('label').css('font-size',opt.labelSize + 'px');
            $tpl.attr('data-json', JSON.stringify( opt ));
        });
        ...
        $('.fb-field-border-radius').change(function(){
            ...
            $tpl.find('.txt-field').css('border-radius',opt.fieldBorderRadius + 'px');
            $tpl.attr('data-json', JSON.stringify( opt ));
        });
        ...
        $('.fb-label-text').on('keyup', function(){
            ...
            $tpl.find('.tpl-block-content').children('label').children('span').text(opt.labelText);
        ...
        $('#fb-field-border-radius-global').change(function(){
            ...
            $('.wrap-tpl-block .tpl-block').each(function(){
                ...
                if (optСurrent.fieldBorderRadius == 'None'){
                    $tplСurrent.find('.txt-field').css('border-radius',opt.fieldBorderRadius + 'px');            
                }
            });
        ...
        $('#fb-field-font-global').change(function(){
			...
			$('.wrap-tpl-block .tpl-block').each(function(){
				...
				if (optСurrent.fieldFont == 'None'){
					$tplСurrent.find('.txt-field').css('font-family',opt.fieldFont + ', sans-serif');			
				}
			});
        });
        ...
        if( id == 'fb-form-background-global' ){
			...
			$('.wrap-tpl-block .tpl-block').each(function(){
				...
				if (optСurrent.fieldBackground == 'None'){
					$tplСurrent.find('.txt-field').css('background-color', optGlobal.fieldBackground);			
				}
			});
            ...
            $('.form-submit-button, .fb-next-page-section, .fb-prev-page-section').css('color',optGlobal.btnColor);
            $tplGlobal.attr('data-json', JSON.stringify( optGlobal ));
        } else if( $el.hasClass('fb-label-color') ){
            opt.labelColor = '#' + hex;
            $tpl.find('.tpl-block-content').children('label').css('color', opt.labelColor);
            $tpl.attr('data-json', JSON.stringify( opt ));
    ...
    setRuleAction: function(){
        ...
        $('.fb-btn-add-condition').on('click', function(){
            $('.fb-set-rule').append('<div class="fb-align-row clearfix">'+
        ...
        $('.fb-set-rule').on('change', '.fb-has-value', function(){
            ...
            if ( val == 'equals' || val == 'not_equal' ){
                $row.find('.fb-item-input .txt-field').val('').show();
    ...
    setRuleBeforeOpen: function(){
        $('.fb-set-rule')
                    ...
                    .html('<div class="fb-align-row clearfix">'+
                        '<div class="fb-align-item">'+
    ...
    pageBreakInit: function(){
        ...
        if($el.length){
            $('#wrap-form-submit-button').prepend('<a href="#" class="t-btn-orange fb-prev-page-section">Previous</a> <a href="#" class="t-btn-orange fb-next-page-section">Next</a>');
            ...
            $el.each(function(i){
                ...
                if ( i == 0){
                    if($this.prevAll('.tpl-block').length){
                        $this.prevAll('.tpl-block').wrapAll('<div class="fb-page-step-section fb-selected"/>');
                    } else {
    ...
    pageBreakDestroy: function(){
        ...
        $('.fb-prev-page-section, .fb-next-page-section, .fb-step-text-page').remove();
    },
	...
	redirectCompetitorsAction: function(){
		...
		$checkRusCompetitors.on('click', function(){
			...
			$('.fb-rus-сompetitors').find('.t-field:not(:eq(0))').remove();
			$('.fb-rus-сompetitors').find('input').val('');
			page.isCountMultipleField( $('.fb-rus-сompetitors') );
...
$(document).ready(function() {
    ...
    $('.db-default-value-phone').inputmask('mask', {'mask': '(999) - 999 - 9999'});
    page.useCaptchaForm();
    page.redirectCompetitors();
	page.btnSubmitAction();
    
    if( $('.fb-wrap-columns-form').hasClass('fb-wrap-two-columns') || $('.fb-wrap-columns-form').hasClass('fb-wrap-three-columns') ){
