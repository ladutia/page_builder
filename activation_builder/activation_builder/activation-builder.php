            ...
            <div class="tab-content-page__inner setup-tab">
                ...
                <div class="right-column">
                    ...
                    <div class="t-field event-elements">
                        ...
                        <div class="t-radio activation_leaderboard_element leaderboard-webview-action-type" <?php echo (!$is_accept_leaderboard)? 'style="display: none;"' : ''; ?>>
                    ...
                    <div class="h3">Active Status:</div>
                    <div class="t-field">
                        <div class="t-radio">
                            <label>
                                <i class="icn-radio"></i>
